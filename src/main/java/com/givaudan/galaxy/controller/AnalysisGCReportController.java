...
@Named
@ViewScoped
public class AnalysisGCReportController implements Serializable {

    private static final Logger logger = Logger.getLogger(AnalysisGCReportController.class.getName());
...
//            response.setHeader("Content-disposition", "attachment;filename=\"" + fileName + "\"");
            ...
            reportUtil.createAnaylsisGCPDF(writer, document, instance, context);
