...
@Named
@ViewScoped
public class AnalysisGCViewController implements Serializable {

    private static final Logger logger = Logger.getLogger(AnalysisGCViewController.class.getName());
    ...
    public void load() {
        ...
        instance = analysisDAO.findAnalysisGCById(id);
    }

    public void openReference() {

        logger.info("openReference called");
        try {
            AnalysisReferenceData data = analysisDAO.findAnalysisReferenceDataByAnalysisID(instance.getId());
